...
const socket = io('https://disaster-backend-9169.onrender.com'); // Replace with your Render URL
...
function App() {
  ...
  const fetchDisasters = async () => {
    try {
      const { data } = await axios.get('https://disaster-backend-9169.onrender.com/disasters'); // Replace with your Render URL
      setDisasters(data);
    } catch (error) {
  ...
  const createDisaster = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://disaster-backend-9169.onrender.com/disasters', { // Replace with your Render URL
        ...form,
  ...
  const submitReport = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://disaster-backend-9169.onrender.com/disasters/123e4567-e89b-12d3-a456-426614174000/verify-image', { // Replace with your Render URL
